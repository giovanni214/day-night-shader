...
use sfml::graphics::{
    Color, RectangleShape, RenderStates, RenderTarget, RenderTexture, Shader, Texture, IntRect,
};
...
fn main() -> std::io::Result<()> {
    ...
    earth_day.load_from_memory(include_bytes!("../earth_day.png"), IntRect::default()).unwrap();
    earth_night.load_from_memory(include_bytes!("../earth_night.png"), IntRect::default()).unwrap();


    println!("Loading shaders...");
    let mut shader = &mut Shader::from_memory_vert_frag(include_str!("../vertex.vert"), include_str!("../day-night-shader.frag"))
